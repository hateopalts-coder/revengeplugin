...
//  Safe settings UI with guards so engine.settings can never crash render
// ─────────────────────────────────────────────────────────────────────────────
...
function safeSettings(): AudioSettings {
  return {
    ...DEFAULT_SETTINGS,
    ...(engine.settings ?? {}),
  };
...
export default function Settings() {
  ...
  function set<K extends keyof AudioSettings>(key: K, val: AudioSettings[K]) {
    ...
    (engine.settings as any)[key] = val;
    tick();
  }
